                ...
                inManagedObjectContext:(NSManagedObjectContext *)context
{
    ...
    */
    ...
    NSLog(@"Deadline Settings are: day = %@, time = %@, next = %@, last = %@, notify = %@, ordinal = %@, whichReminder = %@", deadline.day, deadline.time, deadline.next, deadline.last, deadline.notify, deadline.ordinal, deadline.whichReminder);
...
+(void)checkDeadlinesInManagedObjectContext:(NSManagedObjectContext *)context
{
    ...
    if (!matches) {
        ...
        {
            NSLog(@"checkDeadlinesInManagedObjectContext: Deadline Day = %@", dead.day);
        }
    }
